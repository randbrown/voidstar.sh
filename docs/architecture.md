...
`scripts/gen-app-icons.mjs`: crystal-lotus star-eye qualia · amber chart-lines setlist · teal
neuron-web mind · crystal-lotus bolt tether; qualia/tether are raster art from
